  ...
  <footer class="py-4">
    ...
    <div>
      ...
      <span id="developers" class="d-flex justify-content-around">
        ...
        <div class="d-flex align-items-center"><a href="https://www.linkedin.com/in/alessiowebdev/" target="blank"><img src="{{ asset('images/Alessio-photo.jpg') }}" alt="developer2"></a>
